/**
 * SecureMessaging Page with Post-Quantum Cryptography
 * Enhanced with react-helmet-async for dynamic head management
 */
  ...
  return (
    <HelmetProvider>
      <div className="container mx-auto py-8 space-y-6">
        {/* ✅ Helmet for dynamic head metadata */}
        <Helmet>
          <title>Quantum-Resistant Secure Messaging - TetraCryptPQC</title>
          <meta
            name="description"
            content="End-to-end encrypted messaging with NIST FIPS 205/206 compliant post-quantum cryptography (ML-KEM-1024, ML-DSA-87). Military-grade security for the quantum era."
          />
          <meta name="keywords" content="post-quantum cryptography, secure messaging, ML-KEM, ML-DSA, quantum-resistant, encryption" />
