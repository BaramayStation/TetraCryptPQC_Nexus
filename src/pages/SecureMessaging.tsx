 ...
 * Enhanced with SecureHead for dynamic head management
 */
...
const SecureMessaging: React.FC = () => {
  return (
    <div className="container mx-auto py-8 space-y-6">
      {/* ✅ SecureHead for dynamic head metadata */}
      <SecureHead
        title="Quantum-Resistant Secure Messaging - TetraCryptPQC"
        description="End-to-end encrypted messaging with NIST FIPS 205/206 compliant post-quantum cryptography (ML-KEM-1024, ML-DSA-87). Military-grade security for the quantum era."
        keywords="post-quantum cryptography, secure messaging, ML-KEM, ML-DSA, quantum-resistant, encryption"
      />
